$(function(){
    ...
    $(document).on('mouseover','.usercenter-img-mask',function(){
    	$(this).stop().animate({
    		'opacity':1
    	},200)
    });
    $(document).on('mouseout','.usercenter-img-mask',function(){
        $(this).stop().animate({
            'opacity':0
        },200)
    });
    $(document).on('click','.usercenter-img-mask',function(){
    ...
    $(document).on('click','.wider-show-banner-img-nav .fa-times',function(){
    	$('.wider-show-banner').css({
    		'display':'none',
    	});
    	$('body').css({
